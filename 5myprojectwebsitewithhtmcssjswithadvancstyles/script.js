...
// Function to apply transform on hover
function addHoverEffect() {
  this.style.transform = 'rotate3d(-1, 1, 0, 20deg) scale(1.1)';
}

// Function to remove transform on mouse out
function removeHoverEffect() {
  this.style.transform = 'none';
}

// Attach event listeners to each .card element
cards.forEach(card => {
